...
do
    ...
    nohup bazel run --verbose_failures //programl/task/dataflow:ggnn_test \
        -- --model=/logs/programl/$4/ddf_30/checkpoints/015.Checkpoint.pb \
        --ig -dep_guided_ig --save_vis --only_pred_y --batch --random_test_size 300 \
        --max_vis_graph_complexity $2 --max_removed_edges_ratio $3 --task $4 \
        --filter_adjacant_nodes --instance_id $instance_id --num_instances $1 > ../log/nohup_$4_exp_$2_$3_$1.log 2>&1 &
done